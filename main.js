...
ScrollReveal().reveal('.header-btn', { delay: 1000, duration: 2000, origin: 'bottom' });
ScrollReveal().reveal('.info-left', { distance: '300px', duration: 2000, origin: 'bottom' });
ScrollReveal().reveal('.info-right', { distance: '300px', duration: 2000, origin: 'top' });
ScrollReveal().reveal('#extra-info', { delay: 1000, duration: 2000, origin: 'top', viewFactor:0.2 });
ScrollReveal().reveal('#contact', { delay: 500, duration: 2000, origin: 'top', viewFactor: 0.2 });
